          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-700 text-xs sm:text-sm lg:text-base">Monitor and manage all system transactions</p>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 lg:space-x-3 w-full sm:w-auto">
              ...
              <Button className="neo-brutal bg-green-500 text-white font-bold py-2 px-4 text-xs sm:text-sm w-full sm:w-auto">
            ...
            {isLoading || isRefreshing ? (
              ...
              <>
                {filteredTransactions.map((transaction) => {
                  ...
                  return (
                    <Card key={transaction.id} className="neo-brutal-card">
                      {/* Mobile Layout */}
                      <div className="block sm:hidden p-4">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="text-right">
                            <p className="font-black text-lg text-green-600">${transaction.amount}</p>
                            {transaction.fee > 0 && (
                      ...
                      <div className="hidden sm:block p-6">
                        ...
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <div className="text-right">
                            <p className="font-black text-xl text-green-600">${transaction.amount}</p>
                            {transaction.fee > 0 && (
                              <p className="font-semibold text-xs text-gray-600">Fee: ${transaction.fee}</p>
                            )}
                          </div>
